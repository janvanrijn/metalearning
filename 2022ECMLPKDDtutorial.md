...
This tutorial is given as combined tutorial/workshop. In the afternoon, the program will continue with [the workshop](/metalearning/2022ECMLPKDDworkshop). Beyond other sources, we will discuss the [book on metalearning](/metalearning/book) (Open Access). The tutorial will mostly be given live, in person (but it will be streamed for online participants). A very small part of the tutorial can be pre-recorded.
...
[<img src="GFX/pdffile.png" width="16" />](/metalearning/content/2022ECMLPKDD_tutorial/MetalearningTutorial01_Introduction.pdf){:target="_blank" rel="noopener"}
...
* 10:45 - 11:25: Meta-learning for Algorithm Selection (40m, PB): [<img src="GFX/pdffile.png" width="16" />](/metalearning/content/2022ECMLPKDD_tutorial/MetalearningTutorial02_AlgorithmSelection.pdf){:target="_blank" rel="noopener"}
...
* 12:10 - 12:50: Meta-learning for Few-Shot learning (40m, HG) [<img src="GFX/pdffile.png" width="16" />](/metalearning/content/2022ECMLPKDD_tutorial/MetalearningTutorial04_NeuralNetworks.pdf){:target="_blank" rel="noopener"}
...
* 12:50 - 13:25: Advanced Topics (35m, JvR+PB) [<img src="GFX/pdffile.png" width="16" />](/metalearning/content/2022ECMLPKDD_tutorial/MetalearningTutorial05_AdvancedTopicsI.pdf){:target="_blank" rel="noopener"} [<img src="GFX/pdffile.png" width="16" />](/metalearning/content/2022ECMLPKDD_tutorial/MetalearningTutorial06_AdvancedTopicsII.pdf){:target="_blank" rel="noopener"}
